...
<div class="col-md-12" style="text-align:left">
    ...
    <div class="media">
        <a class="media-left waves-light">
            <img class="img-circle" width='60px' src="{{Session::get('userImage')}}" alt="Generic placeholder image">
        </a>
        <div class="media-body">
            <h4 class="media-heading">Hola {{Session::get('userName')}} !!</h4>
            <p>Bienvenido a Dffusion</p>
        </div>
    </div>
    <div>

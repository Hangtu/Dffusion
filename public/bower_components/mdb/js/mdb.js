...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (! function(t) {
                                    ...
                                    for (var A in C)
                                        if ("element" !== A) {
                                            ...
                                            if (1 === g) M = E.endValue;
                                                ...
                                                if (M = E.startValue + I * O(g, c, I), !p && M === E.currentValue) continue
                                            }
                                            if (E.currentValue = M, "tween" === A) v = M;
                                            else {
                                                ...
                                                var D = x.setPropertyValue(S, A, E.currentValue + (0 === parseFloat(M) ? "" : E.unitType), E.rootPropertyValue, E.scrollData);
                ...
                function o() {
                    function t(t) {
                        ...
                        if ("scroll" === M) {
                            ...
                            for (var F in I)
                                if ("element" !== F) {
                                    var L = I[F].startValue;
                                    I[F].startValue = I[F].currentValue = I[F].endValue, I[F].endValue = L, m.isEmptyObject(y) || (I[F].easing = r.easing), b.debug && console.log("reverse tweensContainer (" + F + "): " + JSON.stringify(I[F]), a)
                                }
                            l = I
                        } else if ("start" === M) {
                            var I;
                            s(a).tweensContainer && s(a).isAnimating === !0 && (I = s(a).tweensContainer), d.each(v, function(t, e) {
                            ...
                            for (var z in v) {
                                ...
                                var B = x.Hooks.getRoot(z),
                                    j = !1;
                                if (s(a).isSVG || "tween" === B || x.Names.prefixCheck(B)[1] !== !1 || x.Normalizations.registered[B] !== n) {
                                    (r.display !== n && null !== r.display && "none" !== r.display || r.visibility !== n && "hidden" !== r.visibility) && /opacity|filter/.test(z) && !H && 0 !== V && (H = 0), r._cacheValues && I && I[z] ? (H === n && (H = I[z].endValue + I[z].unitType), j = s(a).rootPropertyValueCache[B]) : x.Hooks.registered[z] ? H === n ? (j = x.getPropertyValue(a, B), H = x.getPropertyValue(a, z, j)) : j = x.Hooks.templates[B][1] : H === n && (H = x.getPropertyValue(a, z));
                                    var N, $, q, Y = !1;
                                    if (N = f(z, H), H = N[0], q = N[1], N = f(z, V), V = N[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return Y = e, ""
                                        }), $ = N[1], H = parseFloat(H) || 0, V = parseFloat(V) || 0, "%" === $ && (/^(fontSize|lineHeight)$/.test(z) ? (V /= 100, $ = "em") : /^scale/.test(z) ? (V /= 100, $ = "") : /(Red|Green|Blue)$/i.test(z) && (V = V / 100 * 255, $ = "")), /[\/*]/.test(Y)) $ = q;
                                    else if (q !== $ && 0 !== H)
                                        if (0 === V) $ = q;
                                        else {
                                            o = o || g();
                ...
                if (m.isWrapped(this) ? (r = !1, f = 0, p = this, l = this) : (r = !0, f = 1, p = w ? arguments[0].elements || arguments[0].e : arguments[0]), p = a(p)) {
                            ...
                            if (!d.isPlainObject(v) || m.isEmptyObject(v)) {
                                if (m.isString(v) && b.Redirects[v]) {
                                    var O = d.extend({}, y),
                                        I = O.duration,
                                        F = O.delay || 0;
                                    return O.backwards === !0 && (p = d.extend(!0, [], p).reverse()), d.each(p, function(t, e) {
                                        parseFloat(O.stagger) ? O.delay = F + parseFloat(O.stagger) * t : m.isFunction(O.stagger) && (O.delay = F + O.stagger.call(e, t, k)), O.drag && (O.duration = parseFloat(I) || (/^(callout|transition)/.test(v) ? 1e3 : g), O.duration = Math.max(O.duration * (O.backwards ? 1 - t / k : (t + 1) / k), .75 * O.duration, 200)), b.Redirects[v].call(e, e, O || {}, t, k, p, A.promise ? A : n)
                                    }), t()
                                }
                    ...
                    if (O.loop = parseInt(O.loop), z = 2 * O.loop - 1, O.loop)
                        for (var _ = 0; z > _; _++) {
                            ...
                            _ === z - 1 && (V.display = O.display, V.visibility = O.visibility, V.complete = O.complete), C(p, "reverse", V)
                        }
                    return t()
                }
            };
    ...
    function() {
        ...
        var n = i.helpers = {},
            ...
            O = (n.generateLabels = function(t, e, i, n) {
                var a = new Array(e);
            ...
            W = n.getMaximumWidth = function(t) {
                var e = t.parentNode,
                    i = parseInt(B(e, "padding-left")) + parseInt(B(e, "padding-right"));
                return e.clientWidth - i
            },
            H = n.getMaximumHeight = function(t) {
                var e = t.parentNode,
                    i = parseInt(B(e, "padding-bottom")) + parseInt(B(e, "padding-top"));
    ...
    }), Waves.attach(".btn, .btn-floating", ["waves-light"]), Waves.attach(".view .mask", ["waves-light"]), Waves.attach(".waves-light", ["waves-light"]), Waves.attach(".navbar-nav a, .navbar form", ["waves-light"]), Waves.attach(".navbar-brand", ["waves-light"]), Waves.attach(".double-nav li", ["waves-light"]), Waves.init(),
    function(t) {
        ...
        t(["jquery"], function(t) {
            return function() {
                ...
                function w(i) {
                    ...
                    function y() {
                        c.hover(F, I), !o.onclick && o.tapToDismiss && c.click(O), o.closeButton && f && f.click(function(t) {
                            t.stopPropagation ? t.stopPropagation() : void 0 !== t.cancelBubble && t.cancelBubble !== !0 && (t.cancelBubble = !0), O(!0)
                    ...
                    function w() {
                        c.hide(), c[o.showMethod]({
                            ...
                            easing: o.showEasing,
                            complete: o.onShown
                        }), o.timeOut > 0 && (r = setTimeout(O, o.timeOut), p.maxHideTime = parseFloat(o.timeOut), p.hideEta = (new Date).getTime() + p.maxHideTime, o.progressBar && (p.intervalId = setInterval(L, 10)))
                    }
                    ...
                    function I() {
                        (o.timeOut > 0 || o.extendedTimeOut > 0) && (r = setTimeout(O, o.extendedTimeOut), p.maxHideTime = parseFloat(o.extendedTimeOut), p.hideEta = (new Date).getTime() + p.maxHideTime)
                    }
                    ...
                    if ("undefined" != typeof i.optionsOverride && (o = t.extend(o, i.optionsOverride), a = i.optionsOverride.iconClass || a), !E(o, i)) {
                        n++, e = l(o, !0);
                        var r = null,
                            c = t("<div/>"),
                            u = t("<div/>"),
        ...
        t.fn.extend({
            ...
            closeModal: function(i) {
                var n = {
                    ...
                    a = o.data("overlay-id"),
                    s = t("#" + a);
                i = t.extend(n, i), t("body").css("overflow", ""), o.find(".modal-close").off("click.close"), t(document).off("keyup.leanModal" + a), s.velocity({
                    opacity: 0
                }, {
    ...
    function(t, e, i, n) {
        ...
        function st(t, e) {
            var i = e.center,
                ...
                o = t.prevDelta || {},
                a = t.prevInput || {};
            (e.eventType === j || a.eventType === $) && (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function rt(t, e) {
            ...
            if (e.eventType != q && (o > B || i.velocity === n)) {
        ...
        function Et(t, e) {
            ...
            return e & ($ | q) && (i = M(i.concat(n), "identifier", !0)), [i, n]
        }

        function Ft() {
            this.evTarget = It, this.targetIds = {}, it.apply(this, arguments)
        }

        function Lt(t, e) {
            var i = A(t.touches),
                n = this.targetIds;
            if (e & (j | N) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            ...
            return r.length ? [M(a.concat(r), "identifier", !0), r] : void 0
        }
        ...
        function _t(t, e) {
            t & j ? (this.primaryTouch = e.changedPointers[0].identifier, Vt.call(this, e)) : t & ($ | q) && Vt.call(this, e)
        }
        ...
        function Gt(t) {
            ...
            var e = S(t, Yt),
                i = S(t, Xt);
            return e && i ? qt : e || i ? e ? Yt : Xt : S(t, $t) ? $t : Nt
        }
        ...
        function ae(t) {
            this.options = p({}, this.defaults, t || {}), this.id = I(), this.manager = null, this.options.enable = w(this.options.enable, !0), this.state = Kt, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function we(t, e) {
            ...
            if (i.style) {
                ...
                d(t.options.cssProps, function(o, a) {
                    n = E(i.style, a), e ? (t.oldCssProps[n] = i.style[n], i.style[n] = o) : i.style[n] = t.oldCssProps[n] || ""
                }), e || (t.oldCssProps = {})
            }
        }
        ...
        g(bt, it, {
            handler: function(t) {
                var e = vt[t.type];
                e & j && 0 === t.button && (this.pressed = !0), e & N && 1 !== t.which && (e = $), this.pressed && (e & $ && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: W,
                    srcEvent: t
        ...
        t.MSPointerEvent && !t.PointerEvent && (Ct = "MSPointerDown", kt = "MSPointerMove MSPointerUp MSPointerCancel"), g(St, it, {
            handler: function(t) {
                ...
                o & j && (0 === t.button || s) ? 0 > r && (e.push(t), r = e.length - 1) : o & ($ | q) && (i = !0), 0 > r || (e[r] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: a,
                    srcEvent: t
        ...
        Zt.prototype = {
            set: function(t) {
                t == jt && (t = this.compute()), Bt && this.manager.element.style && Qt[t] && (this.manager.element.style[Ht] = t), this.actions = t.toLowerCase().trim()
            },
            update: function() {
        ...
        ae.prototype = {
            ...
            process: function(t) {
                ...
                else if (t.eventType & j) this.reset(), this._timer = u(function() {
        ...
        var e = {
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    ...
                    t("body").append(o), "left" == e.edge ? (n.css("left", -1 * (e.menuWidth + 10)), o.css({
                        left: 0
                    })) : (n.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""), o.css({
                        right: 0
                    ...
                    o.on("click", function() {
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            var d;
                            "left" === e.edge ? (d = s / e.menuWidth, t("#sidenav-overlay").velocity({
                                opacity: d
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (d = Math.abs((s - window.innerWidth) / e.menuWidth), t("#sidenav-overlay").velocity({
                                opacity: d
                            }, {
                                duration: 50,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            s = !1, "left" === e.edge ? r && .3 >= a || -.5 > a ? (n.velocity({
                                left: 0
                            }, {
                                duration: 300,
                                queue: !1,
                                ...
                                right: 0,
                                left: ""
                            })) : (!r || a > .3) && (t("body").css("overflow", ""), n.velocity({
                                left: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                                ...
                                right: "",
                                left: 0
                            })) : (!r || -.3 > a) && (t("body").css("overflow", ""), n.velocity({
                                right: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
            ...
            t(this).each(function() {
                ...
                if (!n.hasClass("browser-default")) {
                    var o = n.attr("multiple") ? !0 : !1,
                        a = n.data("select-id");
                    if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()),
                        "destroy" === e) return void n.data("select-id", null).removeClass("initialized");
    ...
    function() {
        ...
        function C(e, n) {
            function V(t, e) {
                ...
                if (!e || !(v - y > p || p > v + y)) {
                    ...
                    o && s.append(M.canvas), M.setHand(d, f, !e, !0), i.off(l).on(l, function(t) {
                        ...
                        (e || g) && a === d && r === f && M.setHand(a, r), "hours" === M.currentView ? M.toggleView("minutes", w / 2) : n.autoclose && (M.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() {
                            M.done()
                        }, w / 2)), s.prepend(W), clearTimeout(b), M.popover.removeClass("clockpicker-moving"), i.off(l)
                    })
                }
            }
            var a = t(x),
            ...
            if (n.twelvehour)
                for (L = 1; 13 > L; L += 1) D = F.clone(), R = L / 6 * Math.PI, z = v, D.css("font-size", "140%"), D.css({
                    left: m + Math.sin(R) * z - y,
                    top: m - Math.cos(R) * z - y
                }), D.html(0 === L ? "00" : L), f.append(D), D.on(r, V);
            else
                for (L = 0; 24 > L; L += 1) {
            ...
            if (s.on(r, function(e) {
                ...
                var q = h("circle");
                q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), B.appendChild(N), B.appendChild($), B.appendChild(q), B.appendChild(j), H.appendChild(B), W.append(H), this.hand = N, this.bg = $, this.fg = q, this.bearing = j, this.g = B, this.canvas = W
            }
            k(this.options.init)
        }
        ...
        var t = function(t, e, i, n) {
            ...
            o.extend(l, n);
            var c, u, h, d, f, p, m, v, g, y, b, w, x, C, k, S, P, T, A, M, E, O, I, F, L, D, R, z, _, V, W, H, B, j, N, $, q, Y, X, Q, Z, G, U, K, J, tt, et, it, nt, ot, at, st, rt, lt, ct, ut, ht = function() {
                    return {
                        x: 0,
                        y: 0
                    }
                ...
                It = function(t, e, i, n, o) {
                    (!kt || o && o !== a.currItem) && (n /= o ? o.fitRatio : a.currItem.fitRatio), t[O] = w + e + "px, " + i + "px" + x + " scale(" + n + ")"
                },
                Ft = function(t) {
                    nt && (t && (y > a.currItem.fitRatio ? kt || (hi(a.currItem, !1, !0), kt = !0) : kt && (hi(a.currItem), kt = !1)), It(nt, pt.x, pt.y, y))
                },
                Lt = function(t) {
                ...
                Wt = null,
                Ht = function() {
                    Wt && (o.unbind(document, "mousemove", Ht), o.addClass(t, "pswp--has_mouse"), l.mouseUsed = !0, Mt("mouseUsed")), Wt = setTimeout(function() {
                        Wt = null
                    }, 100)
                },
                Bt = function() {
                    o.bind(document, "keydown", a), W.transform && o.bind(a.scrollWrap, "click", a), l.mouseUsed || o.bind(document, "mousemove", Ht), o.bind(window, "resize scroll", a), Mt("bindEvents")
                },
                jt = function() {
                    o.unbind(window, "resize", a), o.unbind(window, "scroll", g.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ht), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, m, a), Mt("unbindEvents")
                },
                Nt = function(t, e) {
                ...
                Xt = function() {
                    ...
                    O = "left", o.addClass(t, "pswp--ie"), Dt = function(t, e) {
                        e.left = t + "px"
                    }, Lt = function(t) {
                ...
                ie = function(t, e, i, n, o, a, s) {
                    ...
                    var c = function() {
                        if (Ut[t]) {
                            if (r = Et() - l, r >= n) return Jt(t), a(i), void(s && s());
                ...
                ne = {
                    ...
                    setScrollOffset: function(t, e) {
                        gt.x = t, V = gt.y = e, Mt("updateScrollOffset", gt)
                    },
                    ...
                    init: function() {
                        if (!c && !u) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), R = t.className, c = !0, W = o.detectFeatures(), L = W.raf, D = W.caf, O = W.transform, _ = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), f = a.container.style, a.itemHolders = S = [{
                            ...
                            Mt("firstUpdate"), d = d || l.index || 0, (isNaN(d) || 0 > d || d >= Je()) && (d = 0), a.currItem = Ke(d), (W.isOldIOSPhone || W.isOldAndroid) && (wt = !1), t.setAttribute("aria-hidden", "false"), l.modal && (wt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === V && (Mt("initialLayout"), V = z = o.getScrollY());
                            var h = "pswp--open ";
                            ...
                            _ || o.bind(a.scrollWrap, v, a), At("initialZoomInEnd", function() {
                                a.setContent(S[0], d - 1), a.setContent(S[2], d + 1), S[0].el.style.display = S[2].el.style.display = "block", l.focus && t.focus(), Bt()
                            }), a.setContent(S[1], d), a.updateCurrItem(), Mt("afterInit"), wt || (C = setInterval(function() {
                                Kt || Y || J || y !== a.currItem.initialZoomLevel || a.updateSize()
                            }, 1e3)), o.addClass(t, "pswp--visible")
                        }
                    },
                    close: function() {
                        c && (c = !1, u = !0, Mt("close"), jt(), ei(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                        Mt("destroy"), Qe && clearTimeout(Qe), t.setAttribute("aria-hidden", "true"), t.className = R, C && clearInterval(C), o.unbind(a.scrollWrap, v, a), o.unbind(window, "scroll", a), Se(), ee(), Tt = null
                    },
                    ...
                    updateCurrZoomItem: function(t) {
                        ...
                        it = a.currItem.bounds, b = y = a.currItem.initialZoomLevel, pt.x = it.center.x, pt.y = it.center.y, t && Mt("afterChange")
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== bt) {
                            var e, i = Math.abs(bt);
                            if (!(t && 2 > i)) {
                                a.currItem = Ke(d), kt = !1, Mt("beforeChange", bt), i >= r && (p += bt + (bt > 0 ? -r : r), i = r);
                                ...
                                bt = 0, a.updateCurrZoomItem(), P = d, Mt("afterChange")
                            }
                        }
                    },
                    updateSize: function(e) {
                        ...
                        if (mt.x = a.scrollWrap.clientWidth, mt.y = a.scrollWrap.clientHeight, Gt(), yt.x = mt.x + Math.round(mt.x * l.spacing), yt.y = mt.y, Rt(yt.x * vt), Mt("beforeResize"), void 0 !== p) {
                        ...
                        b = y = a.currItem.initialZoomLevel, it = a.currItem.bounds, it && (pt.x = it.center.x, pt.y = it.center.y, Ft(!0)), Mt("resize")
                    },
                ...
                Me = {},
                Ee = function(t, e) {
                    return Me.prevent = !Ae(t.target, l.isClickableElement), Mt("preventDragEvent", t, e, Me), Me.prevent
                },
                Oe = function(t, e) {
                ...
                _e = function(t) {
                    ...
                    return I ? (ut = 0, he.forEach(function(t) {
                        0 === ut ? ze[0] = t : 1 === ut && (ze[1] = t), ut++
                    })) : t.type.indexOf("touch") > -1 ? t.touches && t.touches.length > 0 && (ze[0] = Oe(t.touches[0], De), t.touches.length > 1 && (ze[1] = Oe(t.touches[1], Re))) : (De.x = t.pageX, De.y = t.pageY, De.id = "", ze[0] = De), ze
                },
                Ve = function(t, e) {
                    var i, n, o, s, r = 0,
                        c = pt[t] + e[t],
                ...
                We = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!q || "mousedown" !== t.type) {
                            if (Ee(t, !0) && t.preventDefault(), Mt("pointerDown"), I) {
                            ...
                            var i = _e(t),
                                n = i.length;
                            K = null, ee(), Y && 1 !== n || (Y = st = !0, o.bind(window, m, a), N = ct = rt = $ = U = Z = X = Q = !1, at = null, Mt("firstTouchStart", i), _t(ft, pt), dt.x = dt.y = 0, _t(ce, i[0]), _t(ue, ce), de.x = yt.x * vt, fe = [{
                                x: ce.x,
                                y: ce.y
                            }], B = H = Et(), Nt(y, !0), Se(), Pe()), !J && n > 1 && !ot && !U && (b = y, Q = !1, J = X = !0, dt.y = dt.x = 0, _t(ft, pt), _t(se, i[0]), _t(re, i[1]), Ie(se, re, we), be.x = Math.abs(we.x) - pt.x, be.y = Math.abs(we.y) - pt.y, tt = et = ke(se, re))
                        }
                    }
                },
                He = function(t) {
                    ...
                    if (K) {
                        ...
                        if (0 !== t)
                            if (_t(se, K[0]), le.x = se.x - ce.x, le.y = se.y - ce.y, J && t > 1) {
                                ...
                                _t(re, K[1]), Q || (Q = !0, Mt("zoomGestureStarted"));
                                var e = ke(se, re),
                                    i = Ye(e);
                                ...
                                if (o > i)
                                    if (l.pinchToClose && !ct && b <= a.currItem.initialZoomLevel) {
                                        var r = o - i,
                                            c = 1 - r / (o / 1.2);
                                        Ot(c), Mt("onPinchClose", c), rt = !0
                                    } else n = (o - i) / o, n > 1 && (n = 1), i = o - n * (o / 3);
                                else i > s && (n = (i - s) / (6 * o), n > 1 && (n = 1), i = s + n * o);
                                0 > n && (n = 0), tt = e, Ie(se, re, ve), dt.x += ve.x - we.x, dt.y += ve.y - we.y, _t(we, ve), pt.x = zt("x", i), pt.y = zt("y", i), N = i > y, y = i, Ft()
                            } else {
                                if (!at) return;
                                ...
                                if ("v" === at && l.closeOnVerticalDrag && !Te()) {
                                    dt.y += le.y, pt.y += le.y;
                                    var u = Le();
                                    return $ = !0, Mt("onVerticalDrag", u), Ot(u), void Ft()
                                }
                                Fe(Et(), se.x, se.y), Z = !0, it = a.currItem.bounds;
                                var h = Ve("x", le);
                                h || (Ve("y", le), Vt(pt), Ft())
                            }
                    }
                ...
                je = function(t) {
                    ...
                    Mt("pointerUp"), Ee(t, !1) && t.preventDefault();
                    var e;
                    if (I) {
                    ...
                    var u = -1;
                    if (0 === c && (Y = !1, o.unbind(window, m, a), Se(), J ? u = 0 : -1 !== ge && (u = Et() - ge)), ge = 1 === c ? Et() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", J && 2 > c && (J = !1, 1 === c && (s = "zoomPointerUp"), Mt("zoomGestureEnded")), K = null, Z || Q || ot || $)
                        if (ee(), j || (j = Ne()), j.calculateSwipeSpeed("x"), $) {
                            var h = Le();
                            if (h < l.verticalDragRange) a.close();
                                ...
                                ie("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) {
                                    pt.y = (a.currItem.initialPosition.y - d) * t + d, Ot((1 - f) * t + f), Ft()
                                }), Mt("onVerticalDrag", 1)
                            }
                        } else {
                            if ((U || ot) && 0 === c) {
                            ...
                            if (!ot) return "swipe" !== s ? void Xe() : void(!U && y > a.currItem.fitRatio && $e(j))
                        }
                },
                Ne = function() {
                    var t, e, i = {
                ...
                $e = function(t) {
                    return t.calculateSwipeSpeed("y"), it = a.currItem.bounds, t.backAnimDestination = {}, t.backAnimStarted = {}, Math.abs(t.lastFlickSpeed.x) <= .05 && Math.abs(t.lastFlickSpeed.y) <= .05 ? (t.speedDecelerationRatioAbs.x = t.speedDecelerationRatioAbs.y = 0, t.calculateOverBoundsAnimOffset("x"), t.calculateOverBoundsAnimOffset("y"), !0) : (te("zoomPan"), t.lastNow = Et(), void t.panAnimLoop())
                },
                qe = function(t, e) {
                    var i;
                    ot || (me = d);
                    ...
                    var u, h = yt.x * vt,
                        f = Math.abs(h - ye.x);
                    return i || h > ye.x == e.lastFlickSpeed.x > 0 ? (u = Math.abs(e.lastFlickSpeed.x) > 0 ? f / Math.abs(e.lastFlickSpeed.x) : 333, u = Math.min(u, 400), u = Math.max(u, 250)) : u = 333, me === d && (i = !1), ot = !0, Mt("mainScrollAnimStart"), ie("mainScroll", ye.x, h, u, o.easing.cubic.out, Rt, function() {
                        ee(), ot = !1, me = -1, (i || me !== d) && a.updateCurrItem(), Mt("mainScrollAnimComplete")
                ...
                Xe = function() {
                    ...
                    var n, s = 1,
                        r = lt;
                    return rt && !N && !ct && e > y ? (a.close(), !0) : (rt && (n = function(t) {
                        Ot((s - r) * t + r)
            ...
            var Qe, Ze, Ge, Ue, Ke, Je, ti, ei = function(e, i, n, s) {
                    ...
                    var c = n ? l.hideAnimationDuration : l.showAnimationDuration,
                        u = function() {
                            Jt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Ot(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), Mt("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), Ue = !1
                        };
                    if (!c || !r || void 0 === r.x) return Mt("initialZoom" + (n ? "Out" : "In")), y = e.initialZoomLevel, _t(pt, e.initialPosition), Ft(), t.style.opacity = n ? 0 : 1, Ot(1), void(c ? setTimeout(function() {
                        u()
                    }, c) : u());
                    var f = function() {
                        var i = h,
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (y = r.w / e.w, pt.x = r.x, pt.y = r.y - z, a[s ? "template" : "bg"].style.opacity = .001, Ft()), te("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (Mt("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = r.w / e.w,
                                    ...
                                    d = lt,
                                    f = function(e) {
                                        1 === e ? (y = a, pt.x = r.x, pt.y = r.y - V) : (y = (a - h) * e + h, pt.x = (r.x - l.x) * e + l.x, pt.y = (r.y - V - l.y) * e + l.y), Ft(), s ? t.style.opacity = 1 - e : Ot(d - e * d)
                                    };
                                i ? ie("initialZoom", 0, 1, c, o.easing.cubic.out, f, u) : (f(1), Qe = setTimeout(u, c + 20))
                            } else y = e.initialZoomLevel, _t(pt, e.initialPosition), Ft(), Ot(1), s ? t.style.opacity = 1 : Ot(1), Qe = setTimeout(u, c + 20)
                        }, n ? 25 : 90)
                    };
                    f()
                },
                ...
                ri = function(t, e, i) {
                    if (t.src && !t.loadError) {
                        ...
                        if (n && (t.vGap || (t.vGap = {
                                top: 0,
                                bottom: 0
                            }), Mt("parseVerticalMargin", t)), ii.x = e.x, ii.y = e.y - t.vGap.top - t.vGap.bottom, n) {
                            var o = ii.x / t.w,
                                a = ii.y / t.h;
                            t.fitRatio = a > o ? o : a;
                            var s = l.scaleMode;
            ...
            St("Controller", {
                publicMethods: {
                    lazyLoadItem: function(t) {
                        t = Pt(t);
                        var e = Ke(t);
                        e && (!e.loaded && !e.loading || k) && (Mt("gettingData", t, e), e.src && ci(e))
                    },
                    ...
                    setContent: function(t, e) {
                        ...
                        Mt("gettingData", e, s), t.index = e, t.item = s;
            ...
            St("Tap", {
                publicMethods: {
                    ...
                    onTapRelease: function(t, e) {
                        if (e && !Z && !X && !Kt) {
                            var i = e;
                            if (fi && (clearTimeout(fi), fi = null, Ce(i, pi))) return void Mt("doubleTap", i);
            ...
            St("DesktopZoom", {
                publicMethods: {
                    ...
                    handleMouseWheel: function(t) {
                        if (y <= a.currItem.fitRatio) return l.modal && (!l.closeOnScroll || Kt || Y ? t.preventDefault() : O && Math.abs(t.deltaY) > 2 && (h = !0, a.close())), !0;
            ...
            var gi, yi, bi, wi, xi, Ci, ki, Si, Pi, Ti, Ai, Mi, Ei = {
                    history: !0,
                    galleryUID: 1
                },
                Oi = function() {
                ...
                Li = function() {
                    ...
                    Mi ? "#" + i !== window.location.hash && history[Si ? "replaceState" : "pushState"]("", document.title, n) : Si ? Ai.replace(n) : Ai.hash = i, Si = !0, yi = setTimeout(function() {
                        wi = !1
                    }, 60)
                };
            St("History", {
                publicMethods: {
                    initHistory: function() {
                        if (o.extend(l, Ei, !0), l.history) {
                            Ai = window.location, Ti = !1, Pi = !1, Si = !1, ki = Oi(), Mi = "pushState" in history, ki.indexOf("gid=") > -1 && (ki = ki.split("&gid=")[0], ki = ki.split("?gid=")[0]), At("afterChange", a.updateURL), At("unbindEvents", function() {
                                o.unbind(window, "hashchange", a.onHashChange)
                            });
                            var t = function() {
                                Ci = !0, Pi || (Ti ? history.back() : ki ? Ai.hash = ki : Mi ? history.pushState("", document.title, Ai.pathname + Ai.search) : Ai.hash = ""), Ii()
                            };
                            At("unbindEvents", function() {
                                h && t()
                            }), At("destroy", function() {
                    ...
                    onHashChange: function() {
                        return Oi() === ki ? (Pi = !0, void a.close()) : void(wi || (xi = !0, a.goTo(Fi().pid), xi = !1))
                    },
                    updateURL: function() {
                        Ii(), xi || (Si ? gi = setTimeout(Li, 800) : Li())
                    }
                }
            }), o.extend(a, ne)
        };
        ...
        var t = function(t, e) {
            var i, n, o, a, s, r, l, c, u, h, d, f, p, m, v, g, y, b, w, x = this,
                ...
                F = function(e) {
                    ...
                    return t.shout("shareLinkClick", e, i), i.href ? i.hasAttribute("download") ? !0 : (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), S || I(), !1) : !1
                },
                L = function() {
            ...
            x.init = function() {
                e.extend(t.options, P, !0), v = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), h = t.listen, N(), h("beforeChange", x.update), h("doubleTap", function(e) {
                    ...
                    S || I(), b && clearInterval(b), e.unbind(document, "mouseout", _), e.unbind(document, "mousemove", z), e.unbind(n, "pswpTap click", T), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (v.hideAnimationDuration = 0, i.exit()), i = null)
                }), h("destroy", function() {
                ...
                }), h("parseVerticalMargin", B), q(), v.shareEl && r && l && (S = !0), E(), j(), V(), W()
            }, x.setIdle = function(t) {
                u = t, M(n, "ui--idle", t)
            }, x.update = function() {
                k && t.currItem ? (x.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(t.currItem, o), M(o, "caption--empty", !t.currItem.title)), C = !0) : C = !1, S || I(), E()
